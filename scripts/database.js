...
export const getWalkers = () => database.walkers.map(walker => ({...walker}))

export const getPets = () => database.pets.map(pet => ({...pet}))

export const getCities = () => database.cities.map(city => ({...city}))

export const getWalkerCities = () => database.walkerCities.map(walkerCity => ({...walkerCity}))